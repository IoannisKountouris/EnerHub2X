...
*Reserve Market
    FuelusetotalCapUp(tech,time)
    FuelusetotalCapDown(tech,time)
* Strafvariable
...
* Technical limits
    ...
    ReserveCapUp(tech,time)
    ReserveCapDown(tech,time)
* Demand
    eqFLH(tech)
...
FuelusetotalLimProfiles(tech,time)$sum(time1,profile(tech,time1))..
